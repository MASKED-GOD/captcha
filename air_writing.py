...
# Erase All button coordinates
erase_all_x1, erase_all_y1 = 500, 320
erase_all_x2, erase_all_y2 = 600, 370
...
while True:
    ...
    # Draw the "Erase All" button on the frame
    cv2.rectangle(combined_canvas, (erase_all_x1, erase_all_y1), (erase_all_x2, erase_all_y2), (54, 220, 108), -1)  # Green button
    cv2.putText(combined_canvas, "Erase All", (erase_all_x1 + 10, erase_all_y1 + 45), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 0), 2)
    ...
    if op.multi_hand_landmarks:
        for i in op.multi_hand_landmarks:
            ...
            # Check for click on the "Erase All" button
            elif erase_all_x1 < x < erase_all_x2 and erase_all_y1 < y < erase_all_y2:
                canvas[:] = 113  # Reset the canvas to white
